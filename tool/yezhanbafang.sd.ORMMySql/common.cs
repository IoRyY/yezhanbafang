...
namespace " + inamespace + @"
{
    ...
    {";
        ...
        public static void create(IoRyClass iic)
        {
            //获取数据库中的表,视图信息.
            string sql = @"
select a.table_name as tablename,b.column_name as cname,b.data_type as ctype,0 as IsIdentity,b.column_key as ckey ,
b.is_nullable as isnullable,a.table_type as xtype,b.column_comment as gnote,0 as status
