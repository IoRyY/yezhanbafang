    ...
    public class Config : IoRyRow
    {
        ...
        public string str_value
        {
            ...
            set
            {
                ...
                if (value == null)
                {
                    LIC.Where(x => x.ioryName == "str_value").First().ioryValueNull = true;
                }
                else
                {
                    LIC.Where(x => x.ioryName == "str_value").First().ioryValueNull = false;
                }
                LIC.Where(x => x.ioryName == "str_value").First().ioryValueChange = true;
                LIC.Where(x => x.ioryName == "str_value").First().ioryValue = Convert.ToString(value);
            }
        }
        ...
        public string str_table
        {
            ...
            set
            {
                ...
                if (value == null)
                {
                    LIC.Where(x => x.ioryName == "str_table").First().ioryValueNull = true;
                }
                else
                {
                    LIC.Where(x => x.ioryName == "str_table").First().ioryValueNull = false;
                }
                LIC.Where(x => x.ioryName == "str_table").First().ioryValueChange = true;
                LIC.Where(x => x.ioryName == "str_table").First().ioryValue = Convert.ToString(value);
            }
        }
        ...
        public void SetData(DataRow dr)
        {
            ...
            str_value = dr.Field<string>("str_value");
            str_table = dr.Field<string>("str_table");
